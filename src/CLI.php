...
class CLI
{
    ...
    public static function getWidth(int $default = 80) : int
    {
        ...
        if ($width !== false && \is_numeric($width) && (int) $width > 0) {
            return (int) $width;
        }
        $width = \filter_input(\INPUT_SERVER, 'COLUMNS', \FILTER_VALIDATE_INT);
        if ($width !== false && $width !== null && $width > 0) {
            return $width;
        }
        return $default;
    }
    ...
    {
        static::write($text, ForegroundColor::green);
    }
    ...
    {
        static::write($text, ForegroundColor::cyan);
    }
    ...
    public static function clear() : void
    {
        ...
        \fwrite(\STDOUT, \str_repeat(\PHP_EOL, 3));
    }
